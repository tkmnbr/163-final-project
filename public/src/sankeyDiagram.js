...
**************************************************************************************************/
  ...
  // --- Add invisible paths for link tooltips ---
  svg.append("g")
    .selectAll("path")
    .data(sankeyData.links)
    .join("path")
      ...
      .attr("stroke-width", d => Math.max(12, d.width + 8)) // wider for easier hover
      .attr("fill", "none")
      .style("pointer-events", "all")
      .attr("data-tooltip", d => `Source: ${d.source.id}\nTarget: ${d.target.id}\nValue: ${d.value}`);
  ...
  // --- Add invisible rectangles for node tooltips ---
  node.append("rect")
    .attr("x", d => d.x0)
    .attr("y", d => d.y0)
